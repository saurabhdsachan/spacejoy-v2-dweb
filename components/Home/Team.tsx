            ...
            <div className="w-5/12">
              <Scene duration={500} triggerHook={0.2} pin={true} enabled={true} indicators={false}>
                <div>
                  ...
                  <BigText className="text-5xl py-10 text-gray-900">Meet Our Team</BigText>
                </div>
              </Scene>
            </div>
            <ScrollTrigger start="-500px center" end="600px center" scrub={0.5}>
              <div className="w-7/12">
                <div className="grid grid-cols-3 gap-4 xl:gap-8">
                  ...
                  >
                    {TeamData.map((member) => (
                      <div className="bg-gray-100 rounded-xl overflow-hidden" key={member.id}>
                        <Image
                    ...
                    <div>
                      <Link href="/online-interior-designers">
                        <a className="text-white">
                          <div className="group w-full h-full rounded-xl overflow-hidden bg-yellow-400 flex items-end justify-end">
